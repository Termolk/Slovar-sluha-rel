...
public class ListActivity extends AppCompatActivity implements RecyclerViewInterface{
    ...
    private void initPiroList(){
        piroList.add(new CategoryItems(1, "ПИРОТЕХНИКА", "Наташа с мамой вышли на улицу. Было темно. На небе появились искры. Искры были разных цветов. Наташа очень испугалась.", "Это салют. Салюта бояться не надо, он для радости. Люди запускают салюты в небо для красоты.", "0"));
    }
